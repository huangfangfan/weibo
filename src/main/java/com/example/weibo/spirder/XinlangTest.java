...
public class XinlangTest {
    ...
    public XinlangTest(String username, String password) {
    ...
    public void preLogin() throws ClientProtocolException, IOException, URISyntaxException {
        ...
        String url ="https://login.sina.com.cn/sso/prelogin.php?entry=sso&callback=sinaSSOController.preloginCallBack&su="+su+"&rsakt=mod&client=ssologin.js(v1.4.15)&_="+System.currentTimeMillis();
...
//        System.out.println("【登陆新浪通行证成功获得Cookie】:"+this.cookie_xinlanglogin.toString()+"\n");
        ...
        for(Object url : domainurls) {
            ...
            get.setURI(new URI(urlStr + "&callback=sinaSSOController.doCrossDomainCallBack&scriptId=ssoscript0&client=ssologin.js(v1.4.15)&_=" + System.currentTimeMillis()));
//            System.out.println("【请求的url】:" + urlStr+"\n");
    ...
    public void noCrossXinlang(String url) throws URISyntaxException, ClientProtocolException, IOException {
    ...
    public void crossWeibo(String url) throws URISyntaxException, ClientProtocolException, IOException {
        //user_Agent池
        String[] userAgents = {
...
//随机获取总数为14useragent池中的一个
        ...
        String userAgent = userAgents[random.nextInt(15)];
        System.out.print("随机到的useragent是：" + userAgent);
        /*设置代理*/
        ...
        str = str.replaceAll("(\\\\t|\\\\r|\\\\n)", "").replaceAll("\\\\\"", "\"")
                .replaceAll("\\\\/", "/");
        String [] str1 = str.split("<script>FM.view");
...
/**
 * 功能描述:
 * 〈获取通过URL得到的微博页面并做处理，返回处理后的页面字符串〉
 *
 * @param url 1
 ...
 */
    public String crossWeibo1(String url) {
        String[] userAgents = {
                "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/44.0.2403.89 Safari/537.36",
                "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/535.1 (KHTML, like Gecko) Chrome/14.0.835.163 Safari/535.1",
                "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:6.0) Gecko/20100101 Firefox/6.0",
